function validate(validator, a, b) {
  if (b == 'undefied' || b == null || b == '') return validateUnary(validator, a)
...
const deletedValidator = {
  test: (msg, a) => {
    if (a.deletedCount == 1) { msg.res = 'deleting is success'; return true }
    else { msg.err = 'deleted: ' + a.deletedCount; return false }
  }
}
